...
// import { effectsInstances } from "@hooks/useAnimator/effects";
// import { getColorFromGradient } from "@hooks/useAnimator/gradients";
...
//   //   animeStore,
//   //   useShallow((state) => state.groups.flatMap((group: Group) => group.visuals)),
//   // );

//   // const channels = useStore(`
//   //   animeStore,
//   //   useShallow((state) => state.gro
...
//     for (const channelId of Object.values(channels)) channelsToVisuals.set(channelId as Pc.Channel, []);
...
//       const colors: CRGBSum[] = Array(Pc.NUM_LEDS)
//         .fill(null)
//         .map(() => ({
//           r_sum: 0,
//           g_sum: 0,
...
//       queue.push({
//         id: channelId,
//         colors: colors.map((c) => new CRGB(c.r_sum / c.count, c.g_sum / c.count, c.b_sum / c.count)),
//       });
